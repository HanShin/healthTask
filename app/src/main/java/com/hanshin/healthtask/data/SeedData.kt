...
object SeedData {
    ...
    private fun tabata() = ExerciseEntity(
        ...
        guideHeadline = "선택한 맨몸 동작을 20초 수행하고 10초 쉬는 흐름을 8라운드 반복합니다.",
        guideCues = "가이드에서 로우 임팩트 버피·마운틴 클라이머·맨몸 스쿼트 중 한 동작 선택\n정면과 측면 시범으로 안전한 가동 범위 확인\n20초 동안 자세를 유지하며 강하게 운동\n10초는 완전히 쉬고 다음 라운드를 준비",
    ...
    val exercises: List<ExerciseEntity> = listOf(
        ...
        strength(
            ...
            "chest",
            "bodyweight",
            "손바닥과 양발 앞꿈치를 고정하고 머리부터 뒤꿈치까지 일직선을 유지한 채 몸 전체를 함께 내렸다 밀어냅니다.",
            listOf(
                "손은 어깨너비보다 약간 넓게 두고 손바닥 전체와 양발 앞꿈치를 바닥에 고정",
                "복부와 엉덩이를 조여 머리부터 뒤꿈치까지 단단한 일직선 유지",
                "팔꿈치를 몸통 뒤쪽 30~45°로 굽혀 가슴이 바닥에 거의 닿거나 팔꿈치가 약 90°가 될 때까지 몸 전체를 함께 내리기",
                "손바닥으로 바닥을 밀어 몸통 정렬을 유지하며 시작 자세로 복귀",
                "내려가며 들이마시고 올라오며 내쉬기",
            ),
            "허리가 처지거나 엉덩이가 솟고 팔꿈치가 옆으로 벌어지기 전 범위에서 멈추세요. 어깨·팔꿈치·손목에 통증이 있으면 인클라인 또는 무릎 푸시업으로 낮추세요.",
        ),
        ...
        strength(
            ...
            "back",
            "dumbbell",
            "몸통을 고정하고 팔꿈치를 엉덩이 쪽으로 당깁니다.",
            listOf("한 손과 같은 쪽 무릎으로 벤치 지지", "등과 골반의 수평 유지", "손목을 중립으로 유지하며 천천히 내리기"),
            "몸통을 비틀거나 어깨가 바닥으로 처지지 않게 하세요.",
            "https://www.youtube.com/watch?v=bXrkh09AcKg",
        ),
        ...
        strength(
            ...
            "legs",
            "dumbbell",
            "덤벨을 가슴 앞에 세우고 발 전체로 바닥을 밀며 앉았다 일어납니다.",
            listOf("양손으로 위쪽 덤벨 헤드를 깊게 감싸기", "무릎과 발끝을 같은 방향으로 유지", "복압과 중립 척추를 끝까지 유지"),
            "뒤꿈치가 들리거나 무릎이 안쪽으로 무너지기 전 깊이에서 멈추세요.",
        ),
        strength(
            ...
            "legs",
            "dumbbell",
            "뒤발을 벤치에 올리고 앞발 전체에 체중을 실은 채, 몸통을 세워 앞다리 힘으로 내려갔다 일어섭니다.",
            listOf(
                "앞발 전체에 체중을 고르게 싣고 뒤발은 발등을 벤치에 안정적으로 올리기",
                "복부에 힘을 주고 가슴과 몸통을 세운 채 앞무릎과 엉덩이를 함께 굽히기",
                "앞무릎을 발끝과 같은 방향으로 유지하며 앞허벅지가 바닥과 거의 평행한 깊이까지 천천히 내려가기",
                "덤벨은 양옆에서 뉴트럴 그립으로 잡고 팔과 어깨를 흔들지 않기",
                "앞발로 바닥을 밀어 균형을 유지하며 시작 자세로 돌아오기",
            ),
            "앞무릎이 안쪽으로 무너지거나 균형이 깨지고 몸통이 과하게 앞으로 기울기 전 범위에서 멈추세요.",
            "https://www.youtube.com/watch?v=bqKv1toW73Y",
        ),
        ...
        strength(
            ...
            "legs",
            "dumbbell",
            "무릎을 살짝 굽힌 채 엉덩이를 뒤로 보내고, 덤벨을 다리 가까이 내렸다가 엉덩이 힘으로 일어섭니다.",
            listOf(
                "발바닥 전체를 고정하고 무릎 각도를 거의 그대로 유지",
                "손등이 정면을 향하는 오버핸드 그립 유지",
                "허리가 아닌 고관절에서 접으며 엉덩이를 뒤로 이동",
                "덤벨을 허벅지와 정강이 앞 가까이 이동",
                "척추와 목을 중립으로 유지",
            ),
            "허리가 둥글게 말리거나 덤벨이 몸에서 멀어지기 전 가동 범위에서 멈추세요.",
        ),
        ...
        strength(
            ...
            "core",
            "bodyweight",
            "팔꿈치를 어깨 바로 아래에 두고 전완과 발끝으로 지지해 머리부터 뒤꿈치까지 일직선을 유지합니다.",
            listOf(
                "팔꿈치를 어깨 바로 아래에 두고 전완으로 바닥을 단단히 밀기",
                "복부와 엉덩이를 조여 머리·등·골반·뒤꿈치를 일직선으로 유지",
                "골반이 처지거나 솟지 않게 중립 척추를 유지하고 어깨를 안정시키기",
                "시선은 전완 앞쪽 바닥을 향하고 목을 척추의 연장선에 둔 채 계속 호흡하기",
            ),
            "골반과 허리 정렬이 무너지거나 허리·어깨에 통증이 느껴지면 즉시 내려와 쉬고 유지 시간을 줄이세요.",
            video = "https://www.youtube.com/watch?v=QVRZhClEHLw",
        ),
